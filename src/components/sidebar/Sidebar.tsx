...
const Sidebar = () => {
    ...
    return (
        <div className="hidden md:block flex flex-col h-screen p-3 bg-[#F5F5F5] text-black w-60">
                ...
                <div className="flex-1">
                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                        {data?.username == "admin" ? (
                            ...
                            <>
                                <li className="rounded-sm">
                                    <Link href="/me" className="flex items-center p-2 space-x-3 rounded-md hover:bg-white">
                                        <AiFillHome size={26} />
                                        <span className="text-black">Profile</span>
                                    </Link>
                                </li>
                                <li className="rounded-sm">
                                    <Link href="/seller/items" className="flex items-center p-2 space-x-3 rounded-md hover:bg-white">
                                        <AiOutlineInbox size={26} />
